...
function Backend_Architecture() {
  return (
    <section className='pt-[20px] lg:pt-[40px]'>
                ...
                <div className=' px-2 sm:px-0 lg:flex'>


                    <SectionHeader number="03" title="Backend Architecture" />

                    <div className=' pb-[20px]  lg:pt-[38px] lg:pb-[33px] lg:pl-[51px] lg:w-[67%] lg:border-t border-b lg:border-l border-[#FFFFFF]/10  '>
                       <Heading>
                        Rolling my own auth
                       </Heading>
                       <Paragraph>
                       ...
                       <Heading className='pt-[15px] lg:pt-[20px]'>Shared Zod schemas</Heading>
                       <img src={image83} alt='compiler' className=' pb-[10px] lg:pb-[20px]' />
                       ...
                       <Heading className='pt-[15px] lg:pt-[30px]'>Bun everywhere</Heading>
                       <Paragraph>
