...
function Skills() {
 ...
 <div className=' relative bg-[#000000] inline-block w-[40%] '>
        ...
        <div className='border border-[#292929] bg-[#000000] rounded-[8px] pt-[53px]  pb-[85px]'>
          <div className='text-center py-4'>
            ...
            <p className='text-[#BDBDBD] text-[16px] '>Tools and Technologies I Work With</p>
          </div>
          ...
          <div className='absolute bottom-0 -z-0'>
            <img src={Border4} alt='border line' />
