...
function Footer() {
  ...
  return (
    <section className="pb-[60px] px-[20px] sm:px-0 pt-[20px]  sm:pt-[40px] ">
        ...
        <footer className=" lato-regular text-gray-400 pt-[30px] pl-[30px] pr-[31px] pb-[22px] lg:pt-[53px]  lg:pl-[64px]  lg:pr-[98px] lg:pb-[30px] rounded-[16px] border border-[#292929]  mx-auto ">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10 pb-[13px] lg:pb-[33px] ">
            ...
            <div className="w-full lg:w-[36%] flex flex-col">
              <img src={logo} alt="icon" className="w-fit  cursor-pointer" />

              <p className="text-[16px] text-[#BDBDBD] opacity-80 max-w-[320px] pt-[14px] pb-[28px] lg:pt-[24px] lg:pb-[21px] leading-[26px]">
                I’m Ankush — a Shopify Developer, CRO Specialist, freelancer,
                and problem solver. Thanks for checking out my site!
              </p>

              <GradientBorderButton data="Available for work" />
            </div>

            <div className="flex w-full justify-around   lg:w-[64%] xl:pr-20">
              {/* COLUMN 1 */}
              <div>
                <h3 className=" text-[#FFFFFF] font-bold text-[16px] mb-[16px] ">
                  General
                </h3>
                <ul className=" text-[12px] leading-[26px] lg:text-[14px] lg:leading-[28px] opacity-80 flex flex-col ">
                  <Link
                    to="/"
                    className=" text-[#BDBDBD]  cursor-pointer hover:text-gray-100"
                  >
                    {" "}
                    Home
                  </Link>
              ...
              <div>
                ...
                <ul className="text-[12px] leading-[26px] lg:text-[14px] lg:leading-[28px] opacity-80   flex flex-col">
                  <li className="text-[#BDBDBD]  cursor-pointer hover:text-gray-100">
                    Book a call
                  </li>
          ...
          <div className="flex flex-col justify-center border-t-2   border-[#292929] pt-[18px] lg:pt-[21px]  md:flex-row sm:justify-between  text-[#BDBDBD] items-center lg:gap-4 text-[12px] sm:text-[14px] ">
            <div className="flex flex-col md:flex-row items-center justify-center md:gap-[45px] opacity-80">
              <p className="text-center">
                © 2026 Ankush Kumar. All rights reserved
              </p>
            ...
            <div className="flex gap-[15px] lg:gap-[20px] pt-[23px]  md:pt-0 text-white">
              ...
              <a href={linkedin} target="_blank" rel="noopener noreferrer">
                <img
                  src={Vector1}
                  alt="icon"
                  className="cursor-pointer transition-all duration-400 hover:scale-110 h-[14px] w-[14px] md:w-[18px] md:h-[16px]"
                />
              </a>
              {/* github */}
              <a href={github} target="_blank" rel="noopener noreferrer">
                <img
                  src={Vector2}
                  alt="icon"
                  className="h-[14px] w-[14px] md:w-[18px] md:h-[16px] cursor-pointer transition-all duration-400 hover:scale-110"
                />
              </a>
