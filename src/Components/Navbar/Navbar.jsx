...
// import sunImage from "../../assets/Images/sunImage.svg";
// const menuItems = [
//   {
//     label: "Guestbook",
...
//           {/* RIGHT ICON */}
//           <div className=" flex justify-center items-center right-0 z-50 flex  gap-[19px] ">
//             <Link
//               to="/contact"
//               onClick={() => {
//                 setOpen(false);
...
//             <div className="w-[40px] h-[40px] rounded-full bg-[#191919] overflow-hidden flex items-center justify-center">
        ...
        <div className="  flex justify-between items-center py-[16px] hidden md:flex   text-white relative">
          ...
          >
            <motion.div
              initial={{ width: "150px" }}
              animate={{
                width: showGreeting ? "160px" : open ? "700px" : "221px",
              }}
              transition={{ duration: 0.35 }}
              className="bg-[#191919] absolute left-1/2 -top-[18px] -translate-x-1/2 backdrop-blur-2xl border border-white/10 shadow-[0_12px_50px_rgba(0,0,0,0.7)] overflow-hidden rounded-[22px] "
            >
