...
import PrivacyText from '../BlogPage/PrivacyText'
import Policy from '../AboutPage/Policy'
...
function TermsHeading() {
  ...
  cards={[
    {
      icon: <img src={terms1} alt="lock" className="" />,
...
/>
 <Policy
  ...
  cards={[
    {
      icon: <img src={terms9} alt="lock" className="" />,
     ...
     {
      icon: <img src={terms3} alt="lock" className="" />,
      heading: "Limited Use",
...
/>
 <Policy
  ...
  cards={[
    {
      icon: <img src={terms4} alt="lock" className="" />,
      ...
      {
      icon: <img src={terms5} alt="lock" className="" />,
      heading: "No Warranty",
