...
function Next_Project() {
  return (
    <>
        ...
        <div className=' border  border-[#292929] px-6 pt-[53px] pb-[46px] sm:px-[108px] rounded-md flex flex-col gap-6'>
        ...
        <div className='relative'>
            <img src={arrow} alt='arrow' className='absolute -right-2  lg:-right-22' />
        </div>
        </div>
    </div>
