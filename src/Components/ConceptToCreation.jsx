        ...
        <section className='bg-[#000000] py-3'>
            <div className='container'>
                <div className=' relative flex flex-col justify-center items-center border border-[#292929] rounded-[8px] md:py-10 lato-regular overflow-hidden'>
                    ...
                    <img src={Background2} alt='background1' className='absolute left-40 bottom-0 top-0 ' />
                    <img src={Background3} alt='background1' className='absolute right-0 bottom-0 ' />
                    <div> 
                        <img src={aicon} alt=' Aicon' />
                    </div>
                    <div className='text-[44px] font-bold text-[#FFFFFF] mt-3 '>
                        Concept to Creation <span className="bg-gradient-to-r from-[#D76D77] via-[#D76D77] to-[#FFAF7B] bg-clip-text text-transparent">Let’s Make It Happen.</span>
                    </div>

                    <div className='flex justify-center items-center  text-[#FFFFFF] mt-7 relative'>
                        <div>
                            <h1 className='text-[24px] font-bold'>I'm available for full-time roles & freelance projects.</h1>
                            <div className='flex justify-center '>
                                <p className='tetx-[18px]  max-w-[400px] mt-3 opacity-70 text-center'>I thrive on crafting dynamic web applications, and
