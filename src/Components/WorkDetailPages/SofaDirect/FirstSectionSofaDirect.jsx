...
function FirstSectionSofaDirect({project}) {
      if (!project?.headingSofaDirect && !project?.descSofaDirect && !project?.imageSofaDirect) {
    return null;
  }
  return (
...
export default FirstSectionSofaDirect