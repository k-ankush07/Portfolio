...
function FirstSectionHappyStuf({project}) {

      if (!project?.headingHappyStuf && !project?.descHappyStuf && !project?.imageHappyStuf) {
    return null;
  }
  return (
...
export default FirstSectionHappyStuf