...
function OurContributionHappyStuf({project}) {

    if (
    !project?.ourHappyStuf &&
    (!project?.pointsHappyStuf || project.pointsHappyStuf.length === 0) &&
    !project?.contrubutionimageHappyStuf
  ) {
    return null;
  }
  return (
      ...
      <div className="flex flex-col-reverse lg:flex-row">
        ...
        >
          <div className=''>
            ...
            {project.pointsHappyStuf?.length > 0 && (
              <ul className=" pt-[20px]  flex flex-col gap-[5px] lg:gap-[10px]">
                {project.pointsHappyStuf.map((point, i) => (
            ...
            {project.btnnameHappyStuf && (
              
               <a href={project.btnLinkHappyStuf || "#"}
                target="_blank"
        ...
        <div className="w-full lg:w-[75%] ">
          <div className="border-b pb-[20px] lg:pb-0 lg:border-b-0 lg:border-l  border-[#FFFFFF]/10 lg:pl-[40px]  lg:pt-[40px] lg:pb-[40px] ">
            <img src={project.contrubutionimageHappyStuf} alt="contribution image " className="w-full" />
          </div>
        </div>
      </div>
    </div>
...
export default OurContributionHappyStuf