...
function OurContributionProcessLonepouches({project}) {
     if (
    !project?.ourLonepouches &&
    (!project?.pointsLonepouches || project.pointsLonepouches.length === 0) &&
    !project?.contrubutionimageLonepouches
  ) {
    return null;
  }
  return (
      ...
      <div className="flex flex-col-reverse lg:flex-row">
        ...
        >
          <div className='max-w-[341px]'>
            ...
            {project.btnnameLonepouches && (
              
               <a href={project.btnLinkLonepouches || "#"}
                target="_blank"
        ...
        <div className="w-full lg:w-[65%] ">
          <div className="border-b pb-[20px] lg:pb-0 lg:border-b-0 lg:border-l lg:pr-[95px] border-[#FFFFFF]/10 lg:pl-[40px]  lg:pt-[40px] lg:pb-[40px] ">
            <img src={project.contrubutionimageLonepouches} alt="contribution image " className="w-full" />
          </div>
        </div>
      </div>
    </div>
...
export default OurContributionProcessLonepouches