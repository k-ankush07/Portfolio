...
//         <div className="lg:w-[45%] flex flex-col lg:justify-center lg:items-center pt-[20px] lg:pt-0 lg:pr-[40px]">
    ...
    <>
      <div className=" pt-[30px] lg:pt-[40px] ">
        <div className="flex flex-col-reverse lg:flex-row">
          ...
          <div
            style={{
              "--contribution-width": `${project.contributionwidth ?? 45}%`,
            }}
            className="w-full lg:w-[var(--contribution-width)] flex flex-col lg:justify-center lg:items-center pt-[20px] lg:pt-0 lg:pr-[40px]"
          >
            <div>
              ...
              {project.points?.length > 0 && (
                <ul className=" pt-[20px] lg:pt-[16px] flex flex-col gap-[5px] lg:gap-[10px]">
                  {project.points.map((point, i) => (
                    <li
                      key={i}
                      className="text-[14px] leading-[24px]  text-[#BDBDBD]"
                    >
                      <span className="text-[#BDBDBD]">•</span> {point}
                    </li>
                  ))}
