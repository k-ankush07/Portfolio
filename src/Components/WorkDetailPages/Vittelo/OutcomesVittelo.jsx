  ...
  return (
     <div className=" pt-[17px]   lg:pt-[80px]">
      ...
      >
        {/* Image/Video section */}
        <div
          className={`w-full lg:w-[50%] pb-[17px] lg:pl-[95px] lg:pr-[40px] border-r border-white/10   flex justify-center items-center pt-[20px] lg:pt-[41px] lg:pb-[41px] lg:border-b-0 border-white/10 border-b `}
        >
          {isVideo ? (
            <video
