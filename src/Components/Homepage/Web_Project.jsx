  ...
  //                 <span className="absolute left-6 -bottom-4 xl:-bottom-6 bg-[#8f74bf] text-white text-[16px] px-1 md:px-2 md:py-1 rounded-md flex items-center gap-1">
  ...
  //                 <span className="absolute left-6 -bottom-4 xl:-bottom-5 bg-[#d76d77] text-white text-[14px] px-1 md:px-2 md:py-1 rounded-md flex items-center gap-1">
  ...
  //                 <span className="absolute left-6 -bottom-4 xl:-bottom-5 bg-[#14aa4b] text-white text-[14px] px-1 md:px-2 md:py-1 rounded-md flex items-center gap-1">
