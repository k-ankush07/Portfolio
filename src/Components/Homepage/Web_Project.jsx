          ...
          <div className="w-full relative   lg:pb-0 overflow-hidden">
            ...
            <div className="cards_section flex   gap-[6px] sm:gap-[40px] sm:flex-row items-center   pt-[24px] pb-[20px] pl-[18px] pr-[18px]  xl:gap-[143px] lg:pt-[60px]   lg:pb-[51px] lg:pl-[75px] lg:pr-[76px]">
              ...
              <div className={`relative cards-width w-[33.3%] p-[1px] flex justify-center xl:justify-end  ${visible ? 'animate-spread-up' : 'opacity-0'}`}>
                ...
                <span className=" animate-spread-center-bottom bottom_text absolute left-4 -bottom-3 sm:left-[-22px]  xl:-bottom-4 xl:left-1/2 xl:-translate-x-1/2 bg-[#d76d77] border-1 border-[#D70216] text-white text-[14px] px-1 md:px-2 md:py-1 rounded-md flex items-center gap-1">
            ...
            {/* Bottom CTA */}
            <div className=" pt-[4px] pb-[5px] lg:pt-[0px] lg:pb-[40px] text-center flex flex-col items-center w-full">
              <h2 className="text-white leading-[33px] text-[18px] xl:text-[20px] font-bold">
                Let's Build Your Next Web Project
              </h2>
              <p className="text-[#BDBDBD] text-center  text-[12px] leading-[18px] xl:text-[16px] w-[300px] lg:w-full">
