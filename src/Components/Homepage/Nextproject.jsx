  ...
  <div className='bg-[#000000] xl:w-[60%]'>
    ...
    <div className='relative mt-4 lg:-mt-4 group '>
      ...
      <div>
          ...
          {/* left bottom */}
             <img src={skilss5} alt='images'  className={`absolute h-[36px] w-[36px] z-50  md:h-[48px] md:w-[48px] -left-3 -bottom-2 md:-left-[28px] md:-bottom[14px]  lg:bottom-7 lg:-left-3 ${
   ...
   />
             {/* left top */}
              <img src={skilss6} alt='images' className={`absolute h-[36px] w-[36px] z-50 md:h-[48px] md:w-[48px]  -left-3 -top-2 md:-left-[25px] md:-top-[17px] lg:-left-3  lg:top-7 ${
                    show ? showClass : hideClass
                  } `}
              style={{
    "--x": "-120px",
    ...
    animationDelay: "0.1s",
              ...
              />
              {/* right top */}
        <img src={skilss2} alt='images' className={`absolute h-[36px] w-[36px] z-50 -right-1 -top-2 md:h-[48px] md:w-[48px] md:-right-[20px] md:-top-[13px] lg:-right-5 lg:top-10   ${
                    show ? showClass : hideClass
                  } `}
              style={{
    "--x": "-120px",
    ...
    animationDelay: "0.1s",
          ...
          {/* right bottom */}
          <img src={skilss1} alt='images' className={`absolute h-[36px] w-[36px] z-50 md:h-[48px] md:w-[48px] right-0 -bottom-1 md:-right-[20px] md:-bottom-[13px] lg:-right-9 lg:bottom-7   ${
                    show ? showClass : hideClass
                  } `}
              style={{
    "--x": "-120px",
    ...
    animationDelay: "0.1s",
        ...
        {/* right center */}
        <img src={skilss3} alt='images'  className={`absolute h-[36px] w-[36px] z-50 right-[86px] top-[44px]  md:right-[97px] md:top-[54px] md:h-[48px] md:w-[48px]  lg:right-25 lg:top-28 left-center-5  ${
                    show ? showClass : hideClass
                  } `}
              style={{
    "--x": "-120px",
    ...
    animationDelay: "0.1s",
         ...
         {/* left center */}
        <img src={skilss7} alt='images' className={`absolute h-[36px] w-[36px] z-50 md:h-[48px] md:w-[48px] left-[18%] top-[44px] max-xs:top-[36px] md:left-[90px] md:top-[51px] lg:left-25 lg:top-28 left-center  ${
                    show ? showClass : hideClass
                  } `}
              style={{
    "--x": "-120px",
