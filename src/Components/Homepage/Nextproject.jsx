  ...
  return (
    <>
      <div className=" next-Project bg-[#000000]  rounded-[8px] xl:w-[60%] z-10 group">
        <div
          className="innerNext group bg-[#000000] h-[100%] relative flex flex-col justify-center items-center pt-[28px] pb-[39px] pl-[38px] pr-[39px] lg:pt-[53px] lg:pb-[54px]   rounded-[8px] border border-[#292929]   cursor-pointer"
            ...
            <div className="xl:pl-[10px] lg:pb-[42px] lg:pt-[59px]  relative">
              <div>
                ...
                <motion.img
                  ...
                  src={skilss5}
                  alt="images"
                  className={`absolute h-[36px] w-[36px] z-50  md:h-[48px] md:w-[48px] -left-3 -bottom-2 md:-left-[28px] md:-bottom[14px]  lg:bottom-7 lg:-left-3 `}
                />
                {/* left top */}
                <motion.img
                  variants={item}
                  src={skilss6}
                  alt="images"
                  className={`absolute h-[36px] w-[36px] z-50 md:h-[48px] md:w-[48px]  -left-3 -top-2 md:-left-[25px] md:-top-[17px] lg:-left-3  lg:top-7 `}
                />
                {/* right top */}
                <motion.img
                  variants={item}
                  src={skilss2}
                  alt="images"
                  className={`absolute h-[36px] w-[36px] z-50 -right-1 -top-2 md:h-[48px] md:w-[48px] md:-right-[20px] md:-top-[13px] lg:-right-5 lg:top-10 `}
                />
                {/* right bottom */}
                <motion.img
                  variants={item}
                ...
                <motion.img
                  ...
                  src={skilss3}
                  alt="images"
                  className={`absolute h-[36px] w-[36px] z-50 right-[86px] top-[44px]  md:right-[97px] md:top-[54px] md:h-[48px] md:w-[48px]  lg:right-25 lg:top-28 left-center-5  `}
                />
                {/* left center */}
                <motion.img
                  variants={item}
                  src={skilss7}
                  alt="images"
                  className={`absolute h-[36px] w-[36px] z-50 md:h-[48px] md:w-[48px] left-[18%] top-[44px] max-xs:top-[36px] md:left-[90px] md:top-[51px] lg:left-25 lg:top-28 left-center  `}
                />
                {/* main center image */}
                ...
                /> */}
                sfbdsusgfudsgfdewfsdfredqwdwefedsadadza
                <img
                  src={skilss4}
                  alt="images"
