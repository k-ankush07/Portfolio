...
function ToolWeTrust() {
  ...
  return (
    <div
      className="about_class flex w-full xl:w-[33.3%] mb-0 cursor-pointer"
...
>
  ...
  `}
        ...
        <div className=" w-[100%]">
          <div
            className={`tool-text flex items-center justify-between pt-[34px]  sm:pt-[30px] lg:pt-[53px] px-[20px] transition-all duration-400
