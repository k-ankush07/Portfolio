        ...
        <div className="container">
          <div className="relative   flex   justify-center text-center text-white overflow-hidden ">
            ...
            <div className="" style={{ pointerEvents: "none" }}>
              ...
              <div className="relative z-10 section_height ">
                ...
                <div className="inline-block group relative  rounded-[8px] cursor-pointer z-50 lg:pb-[19px]">
          ...
          ${show ? "opacity-100 -translate-y-0" : "opacity-0 -translate-y-10"}`}>
                ...
                <div className="flex flex-col justify-center">
                  <h1 className={`font_section text-[28px]  sm:text-[38px] lg:text-[64px] font-bold mt-4 leading-[76px] transition-all duration-700 ease-out
                    ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
