      ...
      <div className="container">
        <div className="relative flex justify-center text-center text-white overflow-hidden">
          <div className="pt-10 xl:py-20">
            ...
            {/* BACKGROUND */}
            <div className="absolute inset-0 h-[55rem] sm:h-[65rem] lg:h-[70rem] flex justify-center items-center opacity-70 pointer-events-none">
              {show && <WorldGlobe />}
            </div>
            ...
            <div className="relative z-10 section_height">
              ...
              <div className="inline-block group relative rounded-[8px] cursor-pointer">
                ...
                <div className="absolute inset-0 rounded-[8px] p-[1.5px] bg-gradient-to-r from-[#DF7A78] via-[#DF7A78] to-purple-500 opacity-0 group-hover:opacity-100 transition duration-500">
                  <div className="w-full h-full rounded-[8px] bg-[#0b0f19]" />
                </div>

                <div
                  className={`relative flex items-center gap-2 px-2 py-1.5 text-[10.59px] sm:text-[12px] text-white transition-all duration-700 ${
                    show
                ...
                >
                  ...
                  <span className="text-[#c58962] font-bold">
                    Nextnode is launching soon!
                  </span>
                </div>
              </div>
              ...
              {/* Heading */}
              <h1
                className={`font_section text-[28px] sm:text-[38px] lg:text-[64px] font-bold mt-4 leading-tight transition-all duration-700 delay-100 ${
                  show
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-8"
                }`}
              ...
              <div className="px-5 flex justify-center mt-4">
                <p
                  className={`name-text text-gray-300 text-[16px] sm:text-[18px] max-w-[900px] transition-all duration-700 delay-200 ${
                    show
                      ? "opacity-100 translate-y-0"
                      : "opacity-0 translate-y-8"
                  }`}
                >
                  👋 Hello, I'm Ankush Kumar a Full Stack Developer Building
              ...
              {/* BUTTONS */}
              <div
                className={`mt-7 md:mt-6 xl:mt-[43px] flex justify-center gap-3 items-center transition-all duration-700 delay-300 ${
                  show
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-8"
                }`}
              >
                {/* MAIN BUTTON */}
                <button className="btn-slide group flex justify-center items-center gap-4 lg:gap-6 cursor-pointer py-2 pl-3 pr-2 sm:pl-5 sm:py-3 xl:px-3 rounded-full bg-[#e5e5e5] text-black text-[14.06px] md:text-[16px] font-medium overflow-hidden">
                  Let’s Connect

                  <FaArrowRightLong
                    className="text-[14.6px] md:text-[16px] translate-x-0 transition-all duration-500 group-hover:-translate-x-5"
                  />
                </button>

                {/* ICON BUTTON */}
                <div className="flex justify-center items-center group">
                  <div className="btn-slide border border-white px-2 group-hover:border-transparent cursor-pointer py-2 sm:py-3 sm:px-3 bg-white/20 rounded-full transition-all duration-500">
