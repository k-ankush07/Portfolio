...
function Cards({ desc, name, picture, bg }) {
  return (
    <div className='bg-[#181818] p-6 mb-6 md:mb-0 rounded-[16px] h-[300px]  flex flex-col justify-between relative overflow-hidden'>
      ...
      <div>
        ...
        <div className='border-b-[1px] border-gray-600 pt-1 '>
          <p className='text-[14px] text-[#BDBDBD] mt-3  pb-[35px] '>
            {desc}
          </p>
        </div>
      </div>
