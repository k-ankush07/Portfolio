...
function Cards({ desc, name, picture, bg }) {
  return (
    <div className='bg-[#181818] pt-[25px] pb-[25px] px-[21px] lg:pt-[30px] lg:pb-[30px] lg:px-[25px] md:mb-0 rounded-[16px] h-[250px] lg:h-[310px]  flex flex-col justify-between relative overflow-hidden'>
