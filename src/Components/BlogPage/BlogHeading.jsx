...
//                 <div className='text-[#FFFFFF] text-center mt-[172px]'>
//                     <p className='text-[#BDBDBD] text-[14.4px] leading-[21.6px]'>Home / Blog / Every Tool in My Terminal-First Dev Setup</p>
//                     <h2 className='text-[44px] leading-[76.8px] font-bold' >Every Tool in My Terminal-First Dev Setup</h2>
//                     <p className='tet-[18px] leading-[27px]'>Neovim, Wezterm, Tmux, and the rest — what survived two years of daily  use and why I picked each one over the obvious alternatives.</p>
...
//                             <h2 className='text-[24px] leading-[24px] text-[#FFFFFF] font-bold'>Aayush Bharti </h2>
//                             <p className='tet-[14px] leading-[24px] text-[#BDBDBD]'>Oct 19, 2025 / 12 min read</p>
//                         </div>
//                     </div>

//                       <div className='flex flex-col justify-center items-center text-[16px] leading-[24px] lg:pt-[43px] text-[#BDBDBD]'>
//                          <p className='text-center  w-[100%] lg:max-w-[1100px]'>I switched to a terminal-first workflow two years ago and never  looked back. The trigger was embarrassingly mundane: VS Code hit 2.4GB  of RAM during a Next.js debugging session while I had Chrome DevTools  open, and my laptop froze for thirty seconds mid-demo. That same week, I watched a coworker <span> navigate a monorepo in Neovim faster than I could  open the file picker in VS Code.</span></p>

//                          <p className=' pt-[20px] w-[100%] lg:max-w-[1100px]'>I felt slow. Not "I should optimize this" slow — "I'm fighting my own tools" slow. So I committed to replacing every GUI developer tool with a terminal-native equivalent and gave myself three months to get  productive. Everything in this list survived a regular purge — if a tool doesn't make me measurably...</p>


//                         <div className='pt-[27px] space-y-[12px]'>
//                           <h1 className='text-[#FFFFFF] text-[24px] font-bold'>The core four: editor, terminal, shell, multiplexer</h1>
//                           <p>These are load-bearing walls. Swap out anything else and the system  still works. Remove one of these and the whole workflow collapses.</p>
//                         </div>


//                         <div className='pt-[40px]'>
//                             <h2 className='text-[24px] leading-[33px]f font-bold text-[#FFFFFF]'>Neovim</h2>
//                             <p className=' pt-[12px] w-[100%] lg:max-w-[1100px]'>Neovim is the center of gravity. I moved from VS Code because I was tired of  Electron eating memory and the constant extension update churn breaking  my setup every few weeks. With native LSP support and Treesitter for  syntax highlighting, I get the same intelligence features —  autocomplete, go-to-definition, inline diagnostics — but startup takes  40ms instead of four seconds.</p>
//                             <p className=' pt-[20px] w-[100%] lg:max-w-[1100px]'>The real unlock was modal editing. Once you internalize that ciw replaces a word and dd deletes a line without reaching for the mouse, you stop thinking about text manipulation and start thinking about code. I use lazy.nvim for plugin management with about 35 plugins — telescope for fuzzy  finding, nvim-cmp for completion, and conform.nvim for formatting on  save.</p>
//                             <p  className=' pt-[20px] w-[100%] lg:max-w-[1100px]'>The honest limitation: the learning curve is brutal for the first two weeks. You will be slower. You will want to quit. That investment in learning your tools deeply pays compound interest, but nobody tells you how bad week one feels.</p>

//                         </div>
//                         <div  className='pt-[40px]'>
//                             <h2 className='text-[24px] leading-[33px] font-bold text-[#FFFFFF]'>Wezterm</h2>
//                             <p  className=' pt-[12px] w-[100%] lg:max-w-[1100px]'>Wezterm is a GPU-accelerated terminal emulator configured entirely in Lua. I  tried Kitty first — solid performance, terrible config syntax. Alacritty flickered on Wayland and had no tab support. Wezterm nails both. The  killer feature is scriptable keybindings: I have a Lua function that  opens a new tab, cds into a project directory, and attaches the matching Tmux session in one keystroke. The config is a real programming language, not YAML or TOML, so conditionals and loops work naturally.</p>
//                             <CodePreview />
//                             <p className=' pt-[12px] w-[100%] lg:max-w-[1100px]'>One annoyance: Wezterm's multiplexer mode is half-baked compared to Tmux. I stopped trying to replace Tmux with it and let each tool do what it's best at.</p>
//                         </div>

//                         <div className='pt-[40px]'>
//                              <h2 className='text-[24px] leading-[33px] font-bold text-[#FFFFFF]'>ZSH + Oh My Zsh</h2>
//                             <p className=' pt-[12px] w-[100%] lg:max-w-[1100px]'>ZSH with Oh My Zsh is the shell layer. Bash's autocomplete is embarrassing  in 2025 — no inline suggestions, no syntax highlighting as you type, no  smart history search. ZSH's plugin ecosystem fixes all of that.</p>
//                             <p  className=' pt-[20px] w-[100%] lg:max-w-[1100px]'>I run three plugins that matter: zsh-autosuggestions (ghost-text completion from your history), zsh-syntax-highlighting (red text when a command doesn't exist, green when it does), and git (aliases like gco for git checkout). The rest of Oh My Zsh I could take or leave. My .zshrc is 80 lines and loads in under 200ms — if yours takes longer, audit your plugins.</p>
//                         </div>
//                         <div className='pt-[40px]'>
//                             <h2 className='text-[24px] leading-[33px] font-bold text-[#FFFFFF]'>Tmux</h2>
//                             <p className=' pt-[12px] w-[100%] lg:max-w-[1100px]'>Tmux handles session persistence and workspace organization. When my SSH  connection drops or I close my laptop mid-debug session, Tmux keeps  every pane, every running process, every scroll position alive. I tried  Zellij for the modern UX and floating panes, but it crashed twice during production </p>
//                             <p className=' pt-[20px] w-[100%] lg:max-w-[1100px]'>incident debugging — the one time you absolutely need your  multiplexer to be rock solid. Tmux is boring and that's the point.
//                             I have three persistent sessions: work, personal, and scratch. Prefix key is rebound to Ctrl+a (closer to home row than the default Ctrl+b), and I use tmux-resurrect to survive full system reboots</p>
//                             <CodePreview />
//                             <p className=' pt-[12px] w-[100%] lg:max-w-[1100px]'>The only complaint is that Tmux's copy mode keybindings are arcane until you configure vi-mode — but once you do, selecting and yanking text  feels like Neovim.</p>
