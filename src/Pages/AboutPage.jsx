...
function AboutPage() {
  return (
    <div className='lg:pt-[172px] lato-regular'>
      <FullStack />
    <Journey />
    <Engineer  date="Jan 2025 – Present" logo={Roboto} heading="Roboto Studio" heading1="Frontend" heading2=" Engineer"
    ...
    />
      ...
      <Engineer  date="Nov 2024 — Present" logo={newgithub} heading="GitHub" heading1="Open Source" heading2="Developer"
